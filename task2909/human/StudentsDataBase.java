...
public class StudentsDataBase {
    ...
    public static void findDimaOrSasha() {
        for (Student student : students) {
            if (student.getName().equals("Dima")) {System.out.println("Студент Dima есть в базе."); break;}
            if (student.getName().equals("Sasha")) {System.out.println("Студент Sasha есть в базе."); break;}
        }
    }
}